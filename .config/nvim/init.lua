...
-- TODO: run `:Tutor` for a refresher on Neovim
-- TODO: run `:checkhealth` for checking Neovim health
...
-- NOTE: I'm using CaskaydiaCove Nerd Font. It can be found here :) https://www.nerdfonts.com/font-downloads
...
vim.opt.number = true -- show current line number on current line
...
-- FIXME: Figure out nvim auto commands
...
vim.opt.showmode = false -- for hardtime.nvim
